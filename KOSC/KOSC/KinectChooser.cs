...
namespace KOSC
{
    ...
    public class KinectChooser : DrawableGameComponent
    {
        ...
        public KinectChooser(Game game, ColorImageFormat colorFormat)
            : base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.Sensor == null || this.LastStatus != KinectStatus.Connected)
            {
                ...
                this.spriteBatch.DrawString(
                    this.font,
                    txt,
                    new Vector2((Game.GraphicsDevice.Viewport.Width - size.X) / 2, (Game.GraphicsDevice.Viewport.Height / 2) + size.Y + 100),
                    Color.White);
        ...
        protected override void LoadContent()
        {
            ...
            this.chooserBackground = Game.Content.Load<Texture2D>("KOSC Content Banner");
